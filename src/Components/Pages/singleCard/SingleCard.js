...
const SingleCard = ({ machineData, setBookingData }) => {
  ...
  const [disabledWhitelistBtn, setDisabledWhitelistBtn] = useState("")
  console.log(user);
  ...
  const handlePostItem = () => {
    ...
    fetch("http://localhost:5000/whitelist", {
      ...
      .then((res) => res.json())
      .then((data) => {
        console.log("white list data", data);
        setDisabledWhitelistBtn(data?.message)
        toast.success("product added to white list ");
            ...
            <div>
              ...
              <p className="">
                ...
                {user?.emailVerified ? (
                  ...
                  <p className=" text-orange-300">unverified</p>
                )}
              </p>
            </div>
            <div>
