        ...
        <td>
                  {resalePrice && !paid && (
                    <Link to={`/dashboard/payment/${_id}`}>
                      <button className="btn btn-xs btn-outline border-orange-300 text-white bg-orange-400"> pay</button>
                    </Link>
                  )}
                  {resalePrice && paid && (
                    <button className="btn btn-xs btn-outline border-orange-300 text-white bg-orange-400 ">paid</button>
                  )}
                </td>
    </tr>
  );
